          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>Creating projects is essential for hands-on learning, as it helps solidify theoretical knowledge through 
                  real-world application. Projects showcase practical skills, demonstrate problem-solving abilities, and provide 
                  tangible proof of expertise, making them invaluable for both personal growth and professional portfolios.</p>
